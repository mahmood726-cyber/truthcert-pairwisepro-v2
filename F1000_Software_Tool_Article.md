...
1. Open the primary application file in `Truthcert1_work` and load an included demo/example dataset.
...
- Local source package: `Truthcert1_work` under `C:\HTML apps`.
