        # Truthcert Pairwisepro V2: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/truthcert-pairwisepro-v2.git

        ## Objective

        TruthCert PairwisePro v2 combines pairwise meta-analysis with TruthCert certification, adding Doi plot/LFK index, fail-safe N, and QEM methods, with 101/101 tests passing.
        ...
        - Code: https://github.com/mahmood726-cyber/truthcert-pairwisepro-v2.git
